...
public class PlayerController {
	...
	@RequestMapping("/addPlayerAPI")
	@ResponseBody
	public String addPlayerAPI(String userId,Player player,HttpServletRequest request){
		
		return playerService.addPlayer(Integer.parseInt(userId), player);
	}
	...
	@ResponseBody
	public String updatePlayerAPI(Player player,HttpServletRequest request,HttpServletResponse response){
...
//		if(playerService.addOrUpdatePlayer(player))return "success";
		if(playerService.updatePlayer(player))return "success";
		return "faild";
	}
	
	@RequestMapping("/deletePlayerAPI")
	@ResponseBody
	public String deletePlayerAPI(int playerId){
